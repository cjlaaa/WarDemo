...
//    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.55,SCREEN_HEIGHT*0.2));
    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.1,SCREEN_HEIGHT*0.7));
    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.15,SCREEN_HEIGHT*0.55));
    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.2,SCREEN_HEIGHT*0.4));
    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.35,SCREEN_HEIGHT*0.35));
    m_UnitPos.push_back(ccp(SCREEN_WIDTH*0.5,SCREEN_HEIGHT*0.3));
